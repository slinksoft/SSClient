...
char initText[1024] = "SupraSlinkClient [C++ Edition]\r\nVersion: X 3.2.1 Final Version - October 31, 2020\r\n\nSpecial Thanks to: OGenDroX, LeafChicken Trac, Moosehead, & r@z\r\n\nOther Testers: OGenDroX, gav (Nova), LeafChicken, Morphus56K, Paramount, Agenda Suicide, okaygo\r\n\nAuthor:\nSupraFast - Daniel Strusser (base client and all his amazing work)\nSlink - Dan (merging EmulinkerSF and Emulinker X, enhancing Supra Client to Slink Client, adding additional features and optimizing performance)\r\n\nEmail: realslinksoft@gmail.com\r\n\r\n# To get started, click on the button below that says [Servers] #\n\0";
